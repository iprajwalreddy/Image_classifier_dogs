...
def get_input_args():
    ...
    parser = argparse.ArgumentParser(description = "Dog Classifier Args")
    
    parser.add_argument("--dir", type=str, default="pet_images/", help="path to the folder of pet images")
    parser.add_argument("--arch", type=str, default="vgg", help="CNN model architecture used for image recognition")
